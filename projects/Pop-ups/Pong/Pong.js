...
function updateValues() {
  ...
  function pMove() {
    ...
    if (p2 && !p2.closed) {
      p2.moveTo(screenWidth - pWidth, p2y);
  ...
  function ballMove() {
    ...
    if (ballX + ballWidth >= screenWidth || ballX <= 0) {
    ...
    if (
      ballX + ballWidth >= screenWidth - pWidth &&
    ...
    ballX = Math.max(0, Math.min(ballX, screenWidth - ballWidth));
