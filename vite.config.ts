...
function isKnownAppRoute(url: string) {
  return ['/', '/vite', '/vite/', '/admin', '/admin/', '/vite/admin', '/vite/admin/', '/admin/auth', '/admin/auth/', '/vite/admin/auth', '/vite/admin/auth/'].includes(url)
}
    ...
    react(),
    {
      ...
      configureServer(server) {
        server.middlewares.use((req, _res, next) => {
          const url = req.url ?? ''
          const viteRoutes = ['/vite', '/vite/', '/admin', '/admin/', '/vite/admin', '/vite/admin/', '/admin/auth', '/admin/auth/', '/vite/admin/auth', '/vite/admin/auth/']
